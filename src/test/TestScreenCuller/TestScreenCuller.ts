...
export class TestScreenCuller extends Component<null> implements Disposable {
  ...
  constructor(
    ...
    super();
    this.renderer = new TestRenderer(document.createElement("div"));
    this.renderer.clippingPlanes = this.components.renderer.clippingPlanes;
  ...
  updateVisibility = (force?: boolean) => {
    ...
    // Instantiate methods at TestRenderer
    // // @ts-ignore
